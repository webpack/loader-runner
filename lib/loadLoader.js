...
module.exports = function loadLoader(loader, resolve, callback) {
	resolve = resolve || function(request, _context, callback) {
		callback(null, request);
	};
	resolve(loader.path, process.cwd(), (err, loaderPath) => {
		if(err) {
			return callback(err);
		}
