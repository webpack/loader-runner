...
// Feature-detected: when the runtime lacks WeakRef (Node < 14.6) the cache is
// silently disabled and loadLoader behaves as before. The engines range stays
// at >=6.11.5.
...
const hasWeakCache = WeakRefCtor !== null;

// Resolved values are held via WeakRef so the cache never prevents GC of an
// unreferenced module. Dead entries are pruned lazily by cacheGet on next
