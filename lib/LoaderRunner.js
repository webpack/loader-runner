...
function iteratePitchingLoaders(options, loaderContext, requestContext, callback) {
	...
	if(currentLoaderObject.pitchExecuted) {
		...
		return iteratePitchingLoaders(options, loaderContext, requestContext, callback);
	}
	...
	loadLoader(currentLoaderObject, function(err) {
		...
		if(!fn) return iteratePitchingLoaders(options, loaderContext, requestContext, callback);
		...
		runSyncOrAsync(
			...
			function(err) {
				...
				if(hasArg) {
					...
					iteratePitchingLoaders(options, loaderContext, requestContext, callback);
				}
			}
		);
	});
...
exports.runLoaders = function runLoaders(options, callback) {
	...
	iteratePitchingLoaders(processOptions, loaderContext, requestContext, function(err, result) {
		if(err) {
			return callback(err, {
				cacheable: requestContext.cacheable,
